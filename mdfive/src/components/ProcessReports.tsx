...
import { Button, Table, Spinner, Alert, Form, Row, Col, Card } from 'react-bootstrap';
...
const ProcessReports = () => {
  ...
  // Query for getting all processed reports
  const { 
    data: allReports, 
  ...
  // Mutation for processing single report
          ...
          <div className="container mt-5">
            ...
            {processSingleMutation.isSuccess && (
              <Alert variant="success" className="mb-3">
                Report processed successfully! ID: {processSingleMutation.data?.data?.report_id}
              </Alert>
            )}
